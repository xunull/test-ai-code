...
from unet.carvana import CarvanaDataset
...
class Configs(BaseConfigs):
    ...
    def init(self):
        ...
        train_path = Path(r"F:\ml_dataset_home\kaggle\carvana-image-masking-challenge\train")
        mask_path = Path(r"F:\ml_dataset_home\kaggle\carvana-image-masking-challenge\train_masks")
        self.dataset = CarvanaDataset(train_path,
                                      mask_path)
